...
public class ConjurSecretCredentiTest {
	...
	public void mockCredentialFromContextIfNeeded() throws IOException {
		...
		PowerMockito.when(
				ConjurSecretCredentials.credentialFromContextIfNeeded(conjurSecretCredentials, credentialID, context))
	...
	public void mockCredentialWithId() {
		...
		PowerMockito.when(ConjurSecretCredentials.credentialWithID(credentialID, context))
